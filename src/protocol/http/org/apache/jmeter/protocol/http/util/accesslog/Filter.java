 ...
 * or regular expression pattern.<p>
 ...
 * <br>
 * @author		Peter Lin<br>
 * @version 	$Revision: 324592 $ last updated $Date: 2004-05-28 14:09:14 -0700 (Fri, 28 May 2004) $
...
public interface Filter {
	...
	/**
	 * Exclude any log entry that contains
	 * the following regular expression
	 * pattern.
	 * @param regexp
	 */
	...
	/**
	 * Log parser will call this method to
	 * see if a particular entry should be
	 * filtered or not.
	 * @param path
	 * @return boolean
	 */
	...
	/**
	 * In case the user wants to replace
	 * the file extension, log parsers
	 * should call this method. This is
	 * useful for regression test plans.
	 * If a website is migrating from one
	 * platform to another and the file
	 * extension changes, the filter
