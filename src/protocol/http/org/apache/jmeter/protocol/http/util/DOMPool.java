 ...
 * equivalent. If I was familiar with Apache Commons Pool, I would probably
 * use it, but since I don't know the API, it is quicker for Proof of Concept
 * to just write a dumb one. If the number documents in the pool exceed several
 * hundred, it will take a long time for the lookup.
 * <p>
 * Created on:  Jun 17, 2003<br>
 * 
 * @author Peter Lin
 * @version $Revision: 325042 $
 */
