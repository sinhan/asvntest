...
public class SamplingStatCalculator implements Serializable
{
   static Logger log = LoggingManager.getLoggerForClass();
	...
	public long getElapsed(){
		if (getCurrentSample().endTime == 0) return 0;// No samples collected ...
    ...
    {
		if (calculator.getCount() == 0) return 0.0; //Better behaviour when howLong=0 or lastTime=0
