...
/**
 * BeanShell setup function - encapsulates all the access to the BeanShell Interpreter
 * in a single class.
 *
 ...
 *
 * @version    $Revision: 325176 $ Updated on: $Date: 2005-03-06 16:25:56 -0800 (Sun, 06 Mar 2005) $
 */
...
public class BeanShellInterpreter
{
	...
	static{
		Method get=null, eval=null, set=null, source=null;// Temporary, so can set the final ones
		Class clazz = null;
	...
	transient private Object bshInstance = null; // The interpreter instance for this class
	...
	public void init(String initFile, Object logger) 
	    throws IOException, JMeterException
	{
